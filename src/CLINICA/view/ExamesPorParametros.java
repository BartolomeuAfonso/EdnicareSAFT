 ...
 * @author Sebastiao
 */
public class ExamesPorParametros extends javax.swing.JDialog {
    ...
    public ExamesPorParametros(int codigoExame, String data1, String produto, int codigoStatusExame, int codigoPaciente) {
        ...
        this.statusBotaoboolean = statusBotaoboolean;
    ...
    public final void carregarExames(boolean listarTodos) {

        codigoProduto = controllerServico.getCodigoServico(produto);

        List<ResultadoExame> lista = controllerExamesporFazer.getResultadosByPaciente3(codigoPaciente, data1, data2, codigoStatusExame, listarTodos, true, codigoExame, codigoProduto);
