 ...
 * @author bafonso
 */
public class viewParametro extends javax.swing.JFrame {

    /**
     * Creates new form viewParametro
     */
    ResultSet rs;
    Connection con;
    ...
    public ExamesIntegrado getExameIntegrado() {
        examesIntegrado.setDesignacao(jTextField1.getText());
        examesIntegrado.setReferencia(jTextField3.getText());
        examesIntegrado.setUnidade(jTextField2.getText());
        examesIntegrado.setCodigoStatus(1);
        examesIntegrado.setCodigoServico(getCodigoServico());
        examesIntegrado.setResultado(jTextField4.getText());
        if (jRadioButton1.isSelected()) {
            examesIntegrado.setCodigoCategoria(0);
        }
        if (jRadioButton2.isSelected()) {
            examesIntegrado.setCodigoCategoria(getCodigoCategoriaServico());
        }
        return examesIntegrado;
    ...
    private void initComponents() {
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Parametrização"));
        ...
        jLabel7.setText("Organização Microbioligia:");
        ...
        jRadioButton2.setText("Micro - Biologia");
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                                                .addComponent(jRadioButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(29, 29, 29)
                                                .addComponent(jRadioButton2, javax.swing.GroupLayout.DEFAULT_SIZE, 269, Short.MAX_VALUE))
        ...
        jTabbedPane1.addTab("Adicionar Itens", jPanel3);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 0, 51));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("PARAMETROS PARA EXAMES");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!jTextField1.getText().isEmpty()) {
            salvar();
            JOptionPane.showMessageDialog(null, "Parametro salvo com Sucesso");
            limpar();
        } else {
            JOptionPane.showMessageDialog(null, "Campo Designacação é obrigatório!", "Erro", JOptionPane.ERROR_MESSAGE);
        }

    }//GEN-LAST:event_jButton1ActionPerformed

    private void jTextField5CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField5CaretUpdate
        jComboBox1.setModel(new DefaultComboBoxModel(controllerServico.getNomeExamesPorLike(jTextField5.getText().trim()).toArray()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewParametro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
