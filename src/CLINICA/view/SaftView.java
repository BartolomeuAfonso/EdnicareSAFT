...
public class SaftView extends javax.swing.JFrame {
    ...
    public SaftView(int codigoArea) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Resumo da Factura"));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jProgressBar1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jfBK, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sf/ce/imagens/Icons/download.jpg"))); // NOI18N
  ...
  //  controllerFactura.getItemFacturas(getDataFacturaInicio(), getDataFacturaFim());
        if (codigoArea == 1) {
            try {
                ...
                if (result == jfBK.APPROVE_OPTION) {
                    arquivo = jfBK.getSelectedFile().toString().concat(".xml");
...
//        OperacoesIva operacoesIva = new OperacoesIva(con);
...
//    }
    public void gerarXML(File file) {
        Definicoes.file = file;
        this.con = conexao.ConexaoBD();
        System.out.println("Data Inicio:"+getDataFacturaInicio());
