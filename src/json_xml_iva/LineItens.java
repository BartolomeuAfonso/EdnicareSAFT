...
public class LineItens {
    ...
    public class LineItem {
        ...
        String LineNumber = "1";
        LineItensOrderReferences OrderReferences = new LineItensOrderReferences();
        ...
        LineItensReferences References = new LineItensReferences();

        public LineItensReferences getReferences() {
            return References;
        }

        public void setReferences(LineItensReferences References) {
            this.References = References;
        }

        public LineItensOrderReferences getOrderReferences() {
            return OrderReferences;
        }

        public void setOrderReferences(LineItensOrderReferences OrderReferences) {
