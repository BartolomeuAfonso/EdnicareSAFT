    ...
    public static double desconto(String value, double preco, Component frm) {
        ...
        if (!value.trim().equals(value.trim().replaceAll("%", ""))) {
            ...
            if (isDescontoValido(desconto)) {
                ...
                JOptionPane.showMessageDialog(frm, "Desconto invalido."
                        + "\nO valor deve estar no intervalo entre 0 e 100% ", "midvision.com", JOptionPane.WARNING_MESSAGE);
            ...
            if (isDescontoValido(desconto, preco)) {
                ...
                JOptionPane.showMessageDialog(frm, "Desconto invalido."
                        + "\nO valor deve estar no intervalo entre 0 e 100% ", "mindvision.com", JOptionPane.WARNING_MESSAGE);
            }
        }
        return 0.0;
    }
