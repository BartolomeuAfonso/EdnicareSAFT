...
public class InvoiceNota {
    ...
    String CustomerID = "Desconhecido";
//     String TransactionID ="null";
    List<LineItensNota> LineItens = new ArrayList<>();
    ...
    public InvoiceNota(String InvoiceNo) {
...
//    }
    ...
    public List<LineItensNota> getLineItens() {
        return LineItens;
    }

    public void setLineItens(List<LineItensNota> Line) {
        this.LineItens = Line;
    }
