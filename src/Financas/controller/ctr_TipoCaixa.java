...
public class ctr_TipoCaixa {
    ...
    public ctr_TipoCaixa(Connection con) {
        this.con = con;
    }
    
    public int getCodByNome(String nome) {

        sql = "SELECT \"codigo\" FROM  \"tipo_caixa\" WHERE  \"descricao\"  like '" + nome + "'";
    ...
    public String getDescricaoByCod(int Codigo) {
        sql = "SELECT \"descricao\" FROM tipo_caixa WHERE codigo =" + Codigo;
        try {
            ps = con.prepareStatement(sql);
            rs = ps.executeQuery();
            while (rs.next()) {
    ...
    public ArrayList<String> getAll() {
        ...
        sql = "SELECT \"descricao\" AS Descricao FROM  \"tipo_caixa\"";
        try {
            ps = con.prepareStatement(sql);
            rs = ps.executeQuery();
            while (rs.next()) {
