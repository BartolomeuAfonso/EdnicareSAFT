 ...
 * @author El Router
 */
public class frmCentrocusto extends javax.swing.JFrame {
    ...
    public frmCentrocusto(Connection conexao) {
        this();
        initComponents();
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(487, 467));
...
//        frmCadastroCentrocusto hst = new frmCadastroCentrocusto(conexao, this,0,"");
        frmCadastroCentrocusto hst = new frmCadastroCentrocusto(conexao, 0, "");
//        hst.setVisible(true);
//        hst.toFront();
...
//                    frmCadastroCentrocusto hst = new frmCadastroCentrocusto(conexao, this,1,va3);
...
//                        hst.toFront();
                    ...
                    try {
                        ...
                        new frmAlertaExcluzao(conexao, "Deseja realmente excluir o Centro de Custo?", "Código.:", va1, "Registro exluido!!!", "centro").setVisible(true);
                    } catch (Exception ex) {
...
//        jComboBoxCentro.insertItemAt(jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString(), 0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCentrocusto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
