 ...
 * @author El Router
 */
public class viewContasPagar extends javax.swing.JInternalFrame {
  ...
  //  FornecedorController controller;
    ...
    public viewContasPagar(Connection conexao, JDesktopPane desktop) {
        initComponents();
        desktop.add(this);
        this.conexao = conexao;
     //   controller = new FornecedorController(conexao);

        jDateChooser1.setDate(new Date());
        jDateChooser2.setDate(new Date());
      //  jComboBoxFornecedor.setModel(new DefaultComboBoxModel(controller.getListafornecedor().toArray()));
...
//        jTextFieldCheque.setText("" + jTableLancamentos.getValueAt(row, 1));
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("CONTROLO DE CONTAS A PAGAR");
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/novos/icons8_US_Dollar_32px_1.png"))); // NOI18N
