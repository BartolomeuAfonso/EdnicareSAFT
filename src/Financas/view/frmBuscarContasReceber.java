 ...
 * @author El Router
 */
public class frmBuscarContasReceber extends javax.swing.JFrame {

    /**
     * Creates new form frmCadastroCaixa
     */
    private frmContasReceber controladora;
    private int flag;


    public frmBuscarContasReceber() {
        initComponents();
    }

    public frmBuscarContasReceber(frmContasReceber control) {
        this();
        initComponents();
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(825, 544));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmBuscarContasReceber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
