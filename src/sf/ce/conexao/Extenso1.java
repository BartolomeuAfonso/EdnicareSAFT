...
public final class Extenso1 {
    private ArrayList<Integer> nro;
    private BigInteger num;
    private BigDecimal valorMonetario;

    private String Qualificadores[][] = { { "centimo", "centimos" },
    ...
    public Extenso1(BigDecimal dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }

    
    public Extenso1(double dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
    ...
    public void setNumber(BigDecimal dec) throws NumberFormatException {
        ...
        // Mantém o valor informado no escopo da classe para utiliza��o
        // posterior
        ...
        if ((dec.signum() == -1) || (dec.compareTo(maxNumber) == 1)) {
            throw new NumberFormatException(
                    "\nNao sao suportados numeros negativos ou maiores que 999 septilhoes para a conversao de valores monetarios."
                            + "\nNumeros validos vao de 0,00 a 999.999.999.999.999.999.999.999.999,99"
	...
	float n = Float.parseFloat(JOptionPane.showInputDialog("Digite 1 Numero"));
        // Converte do tipo BigDecimal para a String por extenso.
        Extenso1 teste = new Extenso1(new BigDecimal(n));
